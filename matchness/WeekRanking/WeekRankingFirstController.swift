...
class WeekRankingFirstController: UIViewController, UITableViewDelegate , UITableViewDataSource, DZNEmptyDataSetSource, DZNEmptyDataSetDelegate, IndicatorInfoProvider {
    ...
    func getStepWeekDate() {
        getWeekStep { (result) in
            DispatchQueue.main.async {
                ...
                print("今週ステップステップステップステップステップ今週", self.week_step)
